...
#define BUFFER_BASE_ADDR	0x12000000
#define SHARED_BASE_ADDR	0x08000000
#define BUFFER_BASE0_ADDR	0x12100000
#define SHARED_BASE0_ADDR	0x08100000


shared_region *region;
u8 *data_to_cpu0;
shared_region *region_cpu0;
u8 *data_to_cpu1;
...
void shared_mem_init(void)
{
	...
	region_cpu0 = (shared_region *)SHARED_BASE0_ADDR;
	data_to_cpu1 = (u8 *)BUFFER_BASE0_ADDR;
}

...
HD_PWD='F:/Project/RG-2018-YF-001/FPGA/YF-012-V2.2-FPGA/YF-012-V1.0-FPGA/YF-012-V1.0-FPGA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log design_ps_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source design_ps_wrapper.tcl -notrace
